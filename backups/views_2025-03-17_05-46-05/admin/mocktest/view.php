...
<div class="row">
    ...
    <div>
        <button class='success mb-5'><a href='/admin/mocktest/add/<?= $program['id'] ?>'>Add Mock Test</a></button>
    </div>
</div>
<table>
    <thead>
    ...
    <tbody>
        ...
        foreach ($mocktests as $answer): ?>
            <tr>
                ...
                <td>
                    <button class="primary"> <a href="/admin/mocktest/edit/<?= $answer['id'] ?>">Edit</a></button>
                    <button class="danger"> <a href="/admin/mocktest/delete/<?= $answer['id'] ?>" onclick="return confirm('Are you sure to delete?')">Delete</a></button>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
