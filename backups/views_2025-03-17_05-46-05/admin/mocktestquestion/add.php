...
<div class="container">
    ...
    <div class="row">
        <div class="breadcrumb">
            <a href="/admin/quiz/list">Real Exam</a>
            <i class="fas fa-chevron-right"></i>
            <a href="/admin/realexam/add/<?= $quiz['id'] ?>" style="margin-left: 7px;cursor:default">Questions</a>
            <i class="fas fa-chevron-right"></i>
    ...
    <form method="post" action="/admin/realexam/add/<?= $quiz['id'] ?>">
        <table class="table">
            <thead>
                <tr>
                    <th>S.N</th>
...
<script>
    function toggleQuestion(questionId, quizId) {
        ...
        xmlhttp.open("GET", "/ajax/toggle-question/" + action + "/" + questionId + "/" + quizId, true);
        xmlhttp.send();
    }
