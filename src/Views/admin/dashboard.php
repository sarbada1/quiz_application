...
<div class="metrics-container">
    <a href="<?= $url('admin/student/list') ?>" style="text-decoration: none;">
    ...
    <a href="<?= $url('admin/question/list') ?>" style="text-decoration: none;">
    ...
    <?php if ($_SESSION['role'] == 1) { ?>
        <a href="<?= $url('admin/teacher/list') ?>" style="text-decoration: none;">
    ...
    <?php } ?>
    <a href="<?= $url('admin/reports') ?>" style="text-decoration: none;">
...
<div class="quick-actions">
    ...
    <div class="action-buttons">
        <button onclick="window.location = '<?= $url('admin/question/add') ?>'" class="action-btn">
            <i class="fas fa-plus"></i> Add Question
        </button>
        <button onclick="window.location = '<?= $url('admin/quiz/add') ?>'" class="action-btn">
