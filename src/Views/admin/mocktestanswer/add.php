...
<div class="row">
    <div class="breadcrumb">
        ...
        <a href="/admin/mocktestanswer/list/<?= $question['id'] ?>" style="margin-left: 7px;">Answers</a>
        <i class="fas fa-chevron-right"></i>
        <a href="#" style="margin-left: 7px;cursor:default">Create</a>
    </div>
</div>
<form method="post" action="/admin/mocktestanswer/add/<?= $question['id'] ?>" class="form-group">
