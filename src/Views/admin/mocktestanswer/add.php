<?php if (isset($_SESSION['message'])): ?>
    ...
    ?>
<h1>Add Answer for Question: <?= $question['question'] ?></h1>
<div class="row">
    <div class="breadcrumb">
        <a href="<?= $url('admin/question/list') ?>">Question</a>
        <i class="fas fa-chevron-right"></i>
        <a href="<?= $url('admin/mocktestanswer/list/<?= $question[') ?>"id'] ?>" style="margin-left: 7px;">Answers</a>
        <i class="fas fa-chevron-right"></i>
        <a href="#" style="margin-left: 7px;cursor:default">Create</a>
    </div>
</div>
<form method="post" action="<?= $url('admin/mocktestanswer/add/<?= $question[') ?>"id'] ?>" class="form-group">
